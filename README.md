...
## 🙏 致谢
- [llama-cpp-python](https://github.com/JamePeng/llama-cpp-python) (感谢 JamePeng 的llama_cpp_python-0.3.27版本彻底解决了显存泄露问题！)
...
**大多数开源项目最初都是"给自己写的"**。能火的是少数，能国际化的更少。我的项目，**自己用得爽是第一优先级**，其他的都是锦上添花。
